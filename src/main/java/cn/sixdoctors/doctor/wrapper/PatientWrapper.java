...
public class PatientWrapper {
    ...
    public VO<List<PatientVO>> getPatients(int doctorId) {
    ...
    public VO<PatientInfoVO> getPatientInfo(int patientId) {
        return new VO<>(patientService.getPatientInfo(patientId));
    }
